...
class FibonacciBilling {
  ...
  private capTerm: boolean;
  private maxTerm: number;
   ...
   */
  generateBillingSchedule(cycles = 10): BillingCycleInfo[] {
    const schedule: BillingCycleInfo[] = [];
   ...
   */
  getBillingSummary(cycles = 10): BillingSummary {
