...
class FibonacciBilling {
     ...
     * @param {number} options.basePrice - The base price per month
     * @param {number} options.discountRate - Optional discount rate for longer periods (0-1)
     * @param {boolean} options.capTerm - Whether to cap the maximum term length
     * @param {number} options.maxTerm - Maximum term length in months if capped
     */
    constructor(options = {}) {
     ...
     * @param {number} currentCycle - The current billing cycle (0-indexed)
     * @returns {number} - The next billing term in months
     */
     ...
     * @param {number} currentCycle - The current billing cycle (0-indexed)
     * @returns {Object} - Billing information for next cycle
     */
     ...
     * @returns {Array} - Array of billing information for each cycle
     */
     ...
     * @param {number} cycles - Number of cycles to summarize
     * @returns {Object} - Summary of total costs and savings
     */
  ...
  module.exports = FibonacciBilling;