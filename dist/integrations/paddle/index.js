...
class FibonacciPaddleIntegration {
    ...
    constructor(options) {
        ...
        this.paddleClient = new paddle_node_sdk_1.Paddle(this.apiKey, {
            environment: this.isSandbox ? paddle_node_sdk_1.Environment.sandbox : paddle_node_sdk_1.Environment.production
        });
    }
    /**
     ...
     */
    extractId(payload, type) {
        var _a;
        // Handle different payload formats
        if ((_a = payload[type]) === null || _a === void 0 ? void 0 : _a.id) {
     ...
     */
    async updateSubscriptionToNextTerm(subscriptionId, currentCycle) {
        try {
            // Get the subscription
            const subscription = await this.paddleClient.subscriptions.get(subscriptionId);
...
exports.default = FibonacciPaddleIntegration;
